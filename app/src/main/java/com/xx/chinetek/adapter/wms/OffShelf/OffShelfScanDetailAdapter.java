...
public class OffShelfScanDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       final OutStockTaskDetailsInfo_Model outStockTaskDetailsInfoModel=outStockTaskDetailsInfoModels.get(selectID);
        ...
        listItemView.txtScanNum.setText(context.getString(R.string.scan_qty)+outStockTaskDetailsInfoModel.getScanQty());
        listItemView.txtRemainQty.setText(context.getString(R.string.pick_num)+outStockTaskDetailsInfoModel.getRePickQty());
        ...
        listItemView.txtbatch.setText((outStockTaskDetailsInfoModel.getIsSpcBatch().toUpperCase().equals("Y")?
                context.getString(R.string.point_batch):context.getString(R.string.batch_l))+outStockTaskDetailsInfoModel.getFromBatchNo());
