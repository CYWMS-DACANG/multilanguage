...
public class UpShelfScanDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       final InStockTaskDetailsInfo_Model inStockTaskDetailsInfoModel=inStockTaskDetailsInfoModels.get(selectID);
        ...
        listItemView.txtScanNum.setText(context.getString(R.string.scan_qty)+inStockTaskDetailsInfoModel.getScanQty());
        listItemView.txtRemainQty.setText(context.getString(R.string.upshelf_num)+inStockTaskDetailsInfoModel.getRemainQty());
        listItemView.txtreferStock.setText(context.getString(R.string.suggestLocal)+GetReferStock(inStockTaskDetailsInfoModel.getLstArea()));
