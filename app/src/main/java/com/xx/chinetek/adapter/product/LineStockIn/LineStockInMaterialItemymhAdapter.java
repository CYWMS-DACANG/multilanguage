...
public class LineStockInMaterialItemymhAdapter extends BaseAdapter {
    private Context context; // 运行上下文
    private ArrayList<LineStockInProductModelymh> lineStockInProductModels; // 信息集合
    ...
    public LineStockInMaterialItemymhAdapter(Context context, ArrayList<LineStockInProductModelymh> lineStockInProductModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LineStockInProductModelymh barCodeInfo=lineStockInProductModels.get(selectID);
        listItemView.txtbarcode.setText(barCodeInfo.getMaterialNo());
        listItemView.txtScanNum.setText(context.getString(R.string.batch)+barCodeInfo.getBatchNo());
        listItemView.txtRemainQty.setText(context.getString(R.string.Received_quantity)+barCodeInfo.getQty());
