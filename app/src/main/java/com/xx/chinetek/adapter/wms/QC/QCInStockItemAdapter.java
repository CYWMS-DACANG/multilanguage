...
public class QCInStockItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtStrVoucherType.setText(context.getString(R.string.qty_l)+stockInfoModel.getQty());
        listItemView.txtCompany.setText(stockInfoModel.getStrongHoldName());
        listItemView.txtdepartment.setText(context.getString(R.string.batch_l)+stockInfoModel.getBatchNo());
