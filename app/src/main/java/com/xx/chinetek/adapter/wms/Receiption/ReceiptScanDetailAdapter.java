...
public class ReceiptScanDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtScanNum.setText(context.getString(R.string.scan_qty)+receiptDetailModel.getScanQty());
        listItemView.txtRemainQty.setText(context.getString(R.string.Received_quantity)+receiptDetailModel.getRemainQty());
