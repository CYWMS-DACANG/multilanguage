...
public class QueryItemAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtAreaNo.setText(context.getString(R.string.stock_location)+stockInfoModel.getAreaNo());
        listItemView.txtMaterialDec.setText(stockInfoModel.getMaterialDesc());
        listItemView.txtQty.setText(context.getString(R.string.Count)+stockInfoModel.getQty()+"");
        listItemView.txtBatchNo.setText(context.getString(R.string.batch_l)+stockInfoModel.getBatchNo());
        listItemView.txtCompany.setText(context.getString(R.string.date_l)+stockInfoModel.getStrongHoldName());
