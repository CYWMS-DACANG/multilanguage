...
public class InnerMoveAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.list_OutLoacl.setText(context.getString(R.string.move_out_warehouse)+stockInfoModel.getFromAreaNo());
        ...
        listItemView.list_SerialNo.setText(context.getString(R.string.sum)+stockInfoModel.getQty().toString());
        return convertView;
    }
}
