...
//    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtCompany.setText(context.getString(R.string.company)+outStockTaskInfoModel.getStrongHoldName());
        listItemView.txtdepartment.setText(context.getString(R.string.department)+outStockTaskInfoModel.getDepartmentName());
        listItemView.txtPcikName.setText(context.getString(R.string.picker)+outStockTaskInfoModel.getPickUserName());
        listItemView.txtFloorName.setText(context.getString(R.string.floor)+outStockTaskInfoModel.getFloorName());
        listItemView.txtStockLeave.setText(context.getString(R.string.location)+outStockTaskInfoModel.getHeightAreaName());
        listItemView.txtVouUser.setText(context.getString(R.string.creator)+outStockTaskInfoModel.getVouUser());
        listItemView.txtIssueType.setText(outStockTaskInfoModel.getIssueType());
       // listItemView.txtCustoms.setText(context.getString(R.string.guest_name_123456));
