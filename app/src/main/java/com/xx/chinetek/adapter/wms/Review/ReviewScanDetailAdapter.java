...
public class ReviewScanDetailAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        listItemView.txtScanNum.setText(context.getString(R.string.scan_qty)+outStockDetailInfoModel.getScanQty());
        listItemView.txtRemainQty.setText(context.getString(R.string.review_num)+outStockDetailInfoModel.getOutStockQty());
