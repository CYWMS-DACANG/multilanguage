...
//        listItemView.txtTaskNo.setText(context.getString(R.string.batch)+woModel.getBatchNo().toString());
        listItemView.txtERPVoucherNo.setText(context.getString(R.string.batch)+woModel.getBatchNo().toString());
//        listItemView.txtStrVoucherType.setText(woModel.getStrVoucherType());
        listItemView.txtCompany.setText(context.getString(R.string.Completed_quantity) + woModel.getScanReportQty().toString());
