...
//            new AlertDialog.Builder(context).setCancelable(false).setTitle(context.getString(R.string.hint)).setIcon(android.R.drawable.ic_dialog_info).setMessage("是否删除组托数据？\n托盘号："+delPalletModel.getPalletNo())
...
//        new AlertDialog.Builder(context).setCancelable(false).setTitle(context.getString(R.string.hint)).setIcon(android.R.drawable.ic_dialog_info).setMessage("是否删除此条序列号？\n序列号："+delBarCodeInfo.getSerialNo())
//                .setPositiveButton(context.getString(R.string.config), new DialogInterface.OnClickListener() {
//                    @Override
//                    public void onClick(DialogInterface dialog, int which) {
//                        // TODO 自动生成的方法
