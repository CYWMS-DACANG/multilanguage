...
public class BillChoice extends BaseActivity {
    ...
    private void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent =null;
        if(this.getTitle().toString().equals(context.getString(R.string.MaterialChange_title)))
        {

        }
        else if(this.getTitle().toString().equals(context.getString(R.string.MaterialChange_out_subtitle)))
        {
        ...
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_receipt_title)))
        {
            intent=new Intent(context, ReceiptionScan.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.TakeSample_title)))
        {
            intent=new Intent(context,TakeSample.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_Package_subtitle)))
        {
            intent=new Intent(context, ReviewScan.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_rawMaterial_subtitle)))
        {
            intent=new Intent(context, OffshelfScan.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_semiproduct_subtitle)))
        {
            intent=new Intent(context, SemiProductScan.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_returnrawMaterial_subtitle)))
        {
            intent=new Intent(context, ProductReturn.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_returnsemiproduct_subtitle)))
        {
            intent=new Intent(context, SemiproductReturn.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_receiptsemiproduct_subtitle)))
        {
            intent=new Intent(context, ReceiptSemiProduct.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_manage_subtitle)))
        {
            intent=new Intent(context,ProductManageAdd.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_Instock)))
        {
            intent=new Intent(context,CompleteProduct.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_tankin_title)))
        {
            intent=new Intent(context,TankIn.class);
        }
        else if(this.getTitle().toString().equals(context.getString(R.string.Product_tankout_title)))
        {
...
//                intent=new Intent(context, ReceiptSemiProduct.class);
//                break;
//            case context.getString(R.string.Product_manage_subtitle):
//                intent=new Intent(context,ProductManageAdd.class);
//                break;
//            case "散成品生产":
//                intent=new Intent(context,CompleteProduct.class);
