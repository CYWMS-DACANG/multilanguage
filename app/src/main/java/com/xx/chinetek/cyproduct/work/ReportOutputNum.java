...
//    TextView txtLast;
    ...
    protected void initData() {
        try{
            ...
            butB.setVisibility(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))? View.VISIBLE:View.GONE);
            butP.setVisibility(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))? View.VISIBLE:View.GONE);

            //托盘
            textView105.setVisibility(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))? View.VISIBLE:View.GONE);

            //货位
            textView116.setVisibility(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))? View.GONE:View.VISIBLE);
            editKu.setVisibility(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))? View.GONE:View.VISIBLE);
...
//            return getString(R.string.Error_PalletypenotMatch);//.getLstBarCode().get(0)
    ...
    protected boolean Check() {
        if(womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))&&!txtWareHousName.getText().toString().contains(context.getString(R.string.finish_product))){
            return false;
        }else{
            return true;
        }
...
//        if (womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))&&BaseApplication.userInfo.getPickWareHouseNo().equals("AD03")){
//            checkflag=true;
//        }
//        if((!womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product)))&&(!BaseApplication.userInfo.getPickWareHouseNo().equals("AD03"))){
//                checkflag=true;
    ...
    private void onClick(View view) {
        try{
            ...
            if (editTxtNumber.getText().toString().isEmpty()||txtBatch.getText().toString().isEmpty()){
                MessageBox.Show(context, context.getString(R.string.txt_isempty));
                return;
            }
...
//                        womodel.setDataType(womodel.getStrVoucherType().toString().equals("散装物料")?"Y":"N");
                    ...
                    try {
                        ...
                        if(!womodel.getStrVoucherType().toString().equals(context.getString(R.string.finish_product))){
                            if(!WgFlag)
                            {
                                MessageBox.Show(context, context.getString(R.string.not_scan_location));
                                return;
                            }
...
//                        if(womodel.getStrVoucherType().toString().equals(context.getString(R.string.semi_product))){
        ...
        try {
            ...
            if (returnMsgModel.getHeaderStatus().equals("S")) {
                ...
                if(String.valueOf(BaseApplication.userInfo.getWarehouseID()).equals(String.valueOf(LWarehouseID))){
                    ...
                    MessageBox.Show(context,context.getString(R.string.AnalysisetT_GetAreaModelADFJson));
                    editKu.setText("");
                    CommonUtil.setEditFocus(editKu);
                }
            } else {
