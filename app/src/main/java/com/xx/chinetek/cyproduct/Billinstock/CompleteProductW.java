...
//                CommonUtil.setEditFocus(edt_filterContent);
            ...
            MessageBox.Show(context,context.getString(R.string.interface_exception));
        }
...
//        }
    ...
    private void onClick(View view) {
        ...
        try{
            ...
            {
                MessageBox.Show(context, R.string.error_in_edit);
                return;
            }
            else{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.action_filter) {
            if (womodel.getBatchNo()==null||womodel.getBatchNo().equals("")){
                MessageBox.Show(context,R.string.barcode_not_print_report);
                return false;
            }
