...
//                CommonUtil.setEditFocus(edt_filterContent);
            ...
            MessageBox.Show(context,R.string.interface_exception);
        }
...
//            butIn.setVisibility(womodel.getStrVoucherType().equals("散装物料")? View.VISIBLE:View.GONE);
            butIn.setVisibility((womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material)))? View.VISIBLE:View.GONE);
            butIOut.setVisibility(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))? View.GONE:View.VISIBLE);
            butT.setVisibility(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))? View.VISIBLE:View.GONE);
            butOut.setVisibility(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))? View.VISIBLE:View.GONE);
...
//            textView75.setVisibility(womodel.getStrVoucherType().equals("散装物料")? View.VISIBLE:View.GONE);
            txtBi.setVisibility((womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material)))? View.VISIBLE:View.GONE);
            textView75.setVisibility((womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material)))? View.VISIBLE:View.GONE);

            //butT托盘去掉
            butT.setVisibility(View.GONE);
            GetWoModel(womodel);

//            if(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))||womodel.getStrVoucherType().equals(context.getString(R.string.semi_product))||womodel.getStrVoucherType().equals("散装物料"))
                if(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))||womodel.getStrVoucherType().equals(context.getString(R.string.semi_product))||womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material)))
            {
                //获取有效期
                String Wotype="0";
                if(womodel.getStrVoucherType().equals(context.getString(R.string.finish_product))){Wotype="2";}
                if(womodel.getStrVoucherType().equals(context.getString(R.string.semi_product))){Wotype="1";}
//                if(womodel.getStrVoucherType().equals("散装物料")){Wotype="3";}
                if(womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material))){Wotype="3";}
    ...
    public void BackAlter() {
        ...
        if (modelsInAll.size()!=0||modelsAll.size()!=0){
            Msg=getString(R.string.confirm_barcode_not_finished_print);
        }
        else{
            Msg=context.getString(R.string.backalter_msg);
        }
        new AlertDialog.Builder(context).setTitle(context.getString(R.string.hint)).setCancelable(false).setIcon(android.R.drawable.ic_dialog_info).setMessage(Msg)
...
//                    {EditW.setText(message1.contains("ST,GS")?meg[2].trim():"");}
            ...
            MessageBox.Show(context,R.string.E_balance_exception);
        }
    ...
    private void onClick(View view) {
        ...
        if (etxtBatch.getText().toString().isEmpty()||txtlineno.getText().toString().isEmpty()||etxtBNumber.getText().toString().isEmpty()){
            MessageBox.Show(context, R.string.txt_isempty);
            return;
        }
        else{
...
//            }
    ...
    public void printlabel(int flag) {
        try {
            ...
            if (Weight.equals(""))
            {
                MessageBox.Show(context, R.string.E_balance_unstable);
                return;
            }
            else{
                if (!CommonUtil.isFloat(Weight)){
                    ...
                    if (!CommonUtil.isFloat(Weight))
                    {
                        MessageBox.Show(context, context.getString(R.string.E_balance_unstable));
                        return;
                    }
                    else{
            ...
            if (flag==1 ){
                ...
                //成品外
                if (womodel.getStrVoucherType().equals(context.getString(R.string.finish_product)))
                {
                    if (txtdate.getText().toString().isEmpty()){
                        MessageBox.Show(context, R.string.exp_date_isempty);
                        return;
                    }
                    if (Float.parseFloat(model.getItemQty())<=0)
                    {
                        MessageBox.Show(context, R.string.weighing_data_error);
                        return;
                    }
                    if (womodel.getMaxProductQty()!=null)
                    {
                        ...
                        {
                            MessageBox.Show(context, getString(R.string.package_qty_max)+ womodel.getMaxProductQty().toString());
                            return;
                        }
                    }
                ...
                if (womodel.getStrVoucherType().equals(context.getString(R.string.semi_product)))
                {
                    //半制外
...
//                if (womodel.getStrVoucherType().equals("散装物料"))
                    if (womodel.getStrVoucherType().equals(context.getString(R.string.bulk_material))||womodel.getStrVoucherType().equals(context.getString(R.string.raw_material)))
                {
                    //散装外
                    model.setSupName("1");
                    model.setItemQty("0");
...
//                model.setProtectWay();
                    if (modelsInAll.size()==0){
                        MessageBox.Show(context, R.string.not_inner_label);
                        return;
                    }
