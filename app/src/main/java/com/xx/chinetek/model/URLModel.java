...
public class URLModel {
    ...
    public String ScanOutStockReviewByBarCodeListADF=GetWCFAdress()+"ScanOutStockReviewByBarCodeListADF";//复核条码扫描
    ...
    public String DeletePalletORBarCodeYmh=GetWCFAdress()+"DeletePalletORBarCodeYmh";//删除组托信息
    ...
    //ymh
    public String SaveT_SingleErpvoucherADF = GetWCFAdress()+"SaveT_SingleErpvoucherADF"; //单独单据扫描提交
