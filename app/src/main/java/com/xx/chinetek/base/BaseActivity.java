...
//            }
    ...
    public void BackAlter(){
        new AlertDialog.Builder(context).setTitle(context.getString(R.string.hint)).setCancelable(false).setIcon(android.R.drawable.ic_dialog_info).setMessage(context.getString(R.string.backalter_msg))
