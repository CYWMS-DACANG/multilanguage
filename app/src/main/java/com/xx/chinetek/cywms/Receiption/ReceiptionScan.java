    ...
    public void onHandleMessage(Message msg) {
        switch (msg.what) {
            ...
            case NetworkError.NET_ERROR_CUSTOM:
                show(context.getString(R.string.get_request_failed)+ msg.obj);
  ...
  //  boolean isDel=false;//删除已扫条码
    ...
    void AnalysisSaveT_InStockDetailADFJson(String result){
        try {
            ...
            if(returnMsgModel.getHeaderStatus().equals("S")){
                new AlertDialog.Builder(context).setTitle(context.getString(R.string.hint)).setCancelable(false).setIcon(android.R.drawable.ic_dialog_info).setMessage(returnMsgModel.getMessage())
