...
//            case context.getString(R.string.QC_title):
//                intent=new Intent(context,QCScan.class);
//                break;
//            case context.getString(R.string.UpShelf_title):
//                intent=new Intent(context,UpShelfScanActivity.class);
//                break;
//            case context.getString(R.string.OffShelf_title):
//                intent=new Intent(context,OffshelfScan.class);
//                break;
//            case context.getString(R.string.Review_title):
//                intent=new Intent(context,ReviewScan.class);
//                break;
//            case context.getString(R.string.Intentory_title):
//                intent=new Intent(context,IntentoryScan.class);
//                break;
//            case context.getString(R.string.MaterialChange_title):
//            case context.getString(R.string.MaterialChange_out_subtitle):
