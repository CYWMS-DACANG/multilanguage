...
public class OffshelfScan extends BaseActivity {
    ...
    private final int RESULT_Delete_PalletORBarCodeADF = 105;
   ...
   Context context=OffshelfScan.this;
    ...
    protected void initViews() {
        ...
        butPallet.setVisibility(View.GONE);
    }
...
//        intent.putExtra("ScanQty",outStockTaskDetailsInfoModel.getRePickQty());
                            ...
                            new AlertDialog.Builder(context).setTitle(context.getString(R.string.hint))
                                    ...
                                    .setPositiveButton(context.getString(R.string.config), new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ...
                                            final Map<String, String> params = new HashMap<String, String>();
                                            params.put("UserJson", userJson);
                                            params.put("PalletNo", stockInfoModels.get(0).getPalletNo());
                                            params.put("languageType", LanguageUtil.getLanguageType(context));
                                            RequestHandler.addRequestWithDialog(Request.Method.POST, TAG_Delete_PalletORBarCodeADF, getString(R.string.Msg_Delete_PalletORBarCodeADF), context, mHandler, RESULT_Delete_PalletORBarCodeADF, null,  URLModel.GetURL().DeletePalletORBarCodeYmh, params, null);
