...
//        edtPort.setEnabled(false);
    ...
    private void btnSetting(View view){
        ...
        if(CommonUtil.MatcherIP(ElecIP)){//CommonUtil.MatcherIP(IPAdress) &&
            ...
            new AlertDialog.Builder(context).setTitle(context.getString(R.string.hint)).setCancelable(false).setMessage(getResources().getString(R.string.SaveSuccess)).setPositiveButton(context.getString(R.string.config), new DialogInterface.OnClickListener() {
                @Override
